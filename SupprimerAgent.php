...
$req= "DELETE FROM agents WHERE cin='$cin' " ;
//appel à la requete :
mysqli_query($connection,$req)or (die(mysqli_error($connection)));
//redirectinon : header("location:afficherAgent.php");
//forword method de client vers le serveur vers le fichier SupprimerAgent puis vers afficherAgent.php qui va retourner la resultat de la requête àl ' agent : 
